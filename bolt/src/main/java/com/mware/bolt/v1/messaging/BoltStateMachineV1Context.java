...
public class BoltStateMachineV1Context implements StateMachineContext {
    ...
    @Override
    public void authenticatedAsUser(String username, String userAgent, Authorizations authorizations) {
        boltChannel.updateUser(username, userAgent, authorizations);
    }
    ...
    @Override
    public BoltChannel boltChannel() {
        return boltChannel;
    }
}
