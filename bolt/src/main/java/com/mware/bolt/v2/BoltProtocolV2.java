...
public class BoltProtocolV2 extends BoltProtocolV1 {
    ...
    public BoltProtocolV2(BoltChannel channel, BoltConnectionFactory connectionFactory, BoltStateMachineFactory machineFactory) {
        super(channel, connectionFactory, machineFactory);
    }
