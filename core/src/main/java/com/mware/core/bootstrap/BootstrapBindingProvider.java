...
/**
 * A BootstrapBindingProvider can add Guice bindings to the bigCONNECT Bootstrap Module.
 * Implementations are automatically discovered by the bigCONNECT Bootstrapper and will be
...
public interface BootstrapBindingProvider {
     ...
     * the bigCONNECT Bootstrap module.
