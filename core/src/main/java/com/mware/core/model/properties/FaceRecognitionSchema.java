...
public interface FaceRecognitionSchema {
    StringBcProperty FACE_DESCRIPTOR = new StringBcProperty("faceDescriptor");
    DateSingleValueBcProperty LAST_FACE_EVENT = new DateSingleValueBcProperty("lastFaceEvent");
    IntegerSingleValueBcProperty NUMBER_OF_FACES = new IntegerSingleValueBcProperty("noFaces");
    BooleanSingleValueBcProperty FACE_PROCESSED = new BooleanSingleValueBcProperty("faceProcessed");
}
