...
public class BcPropertyUpdate {
    ...
    public BcPropertyUpdate(BcProperty property, String propertyKey) {
        this.property = property;
        this.propertyKey = propertyKey;
    }

    public BcPropertyUpdate(SingleValueBcProperty property) {
        this.property = property;
    ...
    public boolean equals(Object o) {
        ...
        BcPropertyUpdate that = (BcPropertyUpdate) o;
