...
public class BcPropertyUpdateRemove extends BcPropertyUpdate {
    ...
    public BcPropertyUpdateRemove(BcProperty property, String propertyKey, long beforeDeleteTimestamp, boolean isDeleted, boolean isHidden) {
    ...
    public BcPropertyUpdateRemove(SingleValueBcProperty property, long beforeDeleteTimestamp, boolean isDeleted, boolean isHidden) {
        super(property);
        this.beforeDeleteTimestamp = beforeDeleteTimestamp;
        this.isDeleted = isDeleted;
        this.isHidden = isHidden;
