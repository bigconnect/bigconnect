...
public abstract class ClientApiSingleValueBcProperty<TClientApi> extends SingleValueBcProperty<TClientApi> {
    private final Class<TClientApi> clazz;

    public ClientApiSingleValueBcProperty(String key, Class<TClientApi> clazz) {
        super(key);
        this.clazz = clazz;
    }
    ...
    public Value wrap(TClientApi value) {
        return Values.of(ClientApiConverter.clientApiToString(value));
    }
