...
import static com.mware.ge.values.storable.Values.doubleArray;
import static com.mware.ge.values.storable.Values.stringArray;

public class DoubleArrayBcProperty extends BcProperty<double[]> {
    public DoubleArrayBcProperty(String key) {
        super(key);
    }
    ...
    @Override
    protected boolean isEquals(double[] newValue, double[] currentValue) {
        return doubleArray(newValue).equals(currentValue);
    }
}
