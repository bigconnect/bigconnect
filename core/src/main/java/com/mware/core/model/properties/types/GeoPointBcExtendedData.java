...
public class GeoPointBcExtendedData extends BcExtendedData<GeoPoint> {
    public GeoPointBcExtendedData(String tableName, String propertyName) {
        super(tableName, propertyName);
    }

    @Override
    public Value rawToGraph(GeoPoint value) {
