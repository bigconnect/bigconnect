...
public class JsonArraySingleValueBcProperty extends SingleValueBcProperty<JSONArray> {
    public JsonArraySingleValueBcProperty(String propertyName) {
        super(propertyName);
    }

    @Override
    public Value wrap(JSONArray value) {
        return Values.stringValue(value.toString());
    }
