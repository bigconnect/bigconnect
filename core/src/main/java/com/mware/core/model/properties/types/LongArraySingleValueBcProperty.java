...
public class LongArraySingleValueBcProperty extends SingleValueBcProperty<long[]> {
    public LongArraySingleValueBcProperty(String propertyName) {
        super(propertyName);
    }

    @Override
    public LongArray wrap(long[] value) {
