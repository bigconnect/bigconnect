...
public class GeRegex implements Regex, Serializable {
    ...
    public String getName() {
        return RegexSchema.REGEX_NAME.getPropertyValue(properties);
    }

    @Override
    public String getPattern() {
        return RegexSchema.REGEX_PATTERN.getPropertyValue(properties);
    }

    @Override
    public String getConcept() {
        return RegexSchema.REGEX_CONCEPT.getPropertyValue(properties);
    }
