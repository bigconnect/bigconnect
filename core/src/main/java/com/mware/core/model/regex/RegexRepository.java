...
public interface RegexRepository {
    ...
    Regex findRegexById(String regexId);
    Regex findByName(String regexName);
    Regex createRegex(String name, String pattern, String concept);
    void updateRegex(String id, String name, String pattern, String concept);
