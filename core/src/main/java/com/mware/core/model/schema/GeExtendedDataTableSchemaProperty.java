...
public class GeExtendedDataTableSchemaProperty extends GeSchemaProperty implements ExtendedDataTableProperty {
    private LinkedHashSet<String> tablePropertyNames = new LinkedHashSet<>();

    public GeExtendedDataTableSchemaProperty(Vertex vertex, ImmutableList<String> dependentPropertyNames, String workspaceId) {
        super(vertex, dependentPropertyNames, workspaceId);
    }
    ...
    void addProperty(String tablePropertyName) {
        this.tablePropertyNames.add(tablePropertyName);
    }
}
