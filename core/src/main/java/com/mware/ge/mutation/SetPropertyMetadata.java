...
public class SetPropertyMetadata {
    ...
    public SetPropertyMetadata(String propertyKey, String propertyName, Visibility propertyVisibility, String metadataName, Value newValue, Visibility metadataVisibility) {
