...
public abstract class QueryResultsSelectManyIterable<TDest extends GeObject> extends SelectManyIterable<Query, TDest> implements QueryResultsIterable<TDest> {
