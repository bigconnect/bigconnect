...
public class ScoringStrategyComparator<T> implements Comparator<T> {
    ...
    public int compare(T o1, T o2) {
        if (o1 instanceof GeObject && o2 instanceof GeObject) {
            Double o1Score = scoringStrategy.getScore((GeObject) o1);
            Double o2Score = scoringStrategy.getScore((GeObject) o2);
