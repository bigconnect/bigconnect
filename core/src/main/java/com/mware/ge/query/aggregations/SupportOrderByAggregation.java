...
public interface SupportOrderByAggregation {
    void setOrderBy(AggregationSortContainer orderBy);
    AggregationSortContainer getOrderBy();

    class AggregationSortContainer implements QueryBase.SortContainer {
        public final Aggregation aggregation;
        public final SortDirection direction;

        public AggregationSortContainer(Aggregation aggregation, SortDirection direction) {
        ...
        public String toString() {
            return this.getClass().getName() + "{" +
                    "aggregationName='" + aggregation.getAggregationName() + '\'' +
                    ", direction=" + direction +
                    '}';
        }
    }
