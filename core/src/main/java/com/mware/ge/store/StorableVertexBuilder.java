...
public abstract class StorableVertexBuilder extends VertexBuilder {
    ...
    public StorableVertexBuilder(String vertexId, String conceptType, Visibility visibility, ElementMutationBuilder elementMutationBuilder) {
        super(vertexId, conceptType, visibility);
