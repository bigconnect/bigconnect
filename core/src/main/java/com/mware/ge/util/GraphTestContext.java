...
public class GraphTestContext {
    ...
    public static void enableEvents() {
        System.setProperty("-eevents", StringUtils.EMPTY);
    }
    ...
    public static void enableProxies() {
        System.setProperty("-eproxy", StringUtils.EMPTY);
    }

    public static boolean eventsEnabled() {
        return resolveProperties().stream().anyMatch(value -> value.equalsIgnoreCase("-eevents"));
    }

    public static boolean proxiesEnabled() {
        return resolveProperties().stream().anyMatch(value -> value.equalsIgnoreCase("-eproxy"));
    }
