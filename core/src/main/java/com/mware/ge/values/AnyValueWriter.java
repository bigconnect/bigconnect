...
public interface AnyValueWriter<E extends Exception> extends ValueWriter<E> {
    void writeNodeReference(String nodeId) throws E;

    void writeNode(String nodeId, TextArray labels, MapValue properties, Authorizations authorizations) throws E;

    void writeRelationshipReference(String relId) throws E;

    void writeRelationship(String relId, String startNodeId, String endNodeId, TextValue type, MapValue properties, Authorizations authorizations) throws E;
    ...
    void writePath(NodeValue[] nodes, RelationshipValue[] relationships, Authorizations authorizations) throws E;
