...
public class DefaultStreamingPropertyValue extends StreamingPropertyValue {
    ...
    public DefaultStreamingPropertyValue(InputStream inputStream, Class<? extends Value> valueType) {
        this(inputStream, valueType, null);
    }

    public DefaultStreamingPropertyValue(InputStream inputStream, Class<? extends Value> valueType, Long length) {
        super(valueType);
