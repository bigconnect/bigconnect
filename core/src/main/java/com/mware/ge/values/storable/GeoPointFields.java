...
public enum GeoPointFields {
    ...
    GeoPointFields(String propertyKey) {
        this.propertyKey = propertyKey;
    }

    public static GeoPointFields fromName(String fieldName) {
    ...
    abstract Value get(GeoPointValue value);
}
