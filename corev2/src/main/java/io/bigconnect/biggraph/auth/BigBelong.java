...
public class BigBelong extends Relationship {
    ...
    public BigBelong(Id user, Id group) {
        this.user = user;
        this.group = group;
    ...
    public static BigBelong fromEdge(Edge edge) {
        BigBelong belong = new BigBelong((Id) edge.outVertex().id(),
                                           (Id) edge.inVertex().id());
    ...
    public static final class P {
        ...
        public static final String USER = BigUser.P.USER;
