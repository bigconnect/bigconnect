...
public class BigGroup extends Entity {
    ...
    public BigGroup(String name) {
        this(null, name);
    }

    public BigGroup(Id id) {
        this(id, null);
    }

    public BigGroup(Id id, String name) {
        this.id = id;
        this.name = name;
    ...
    public static BigGroup fromVertex(Vertex vertex) {
        BigGroup group = new BigGroup((Id) vertex.id());
