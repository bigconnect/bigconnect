...
import io.bigconnect.biggraph.type.Namifiable;
import io.bigconnect.biggraph.type.Typifiable;
...
public class BigResource {
    ...
    public static final BigResource ALL = new BigResource(ResourceType.ALL,
                                                            ANY, null);
    public static final List<BigResource> ALL_RES = ImmutableList.of(ALL);
    ...
    static {
        ...
        module.addSerializer(BigResource.class, new BigResourceSer());
        module.addDeserializer(BigResource.class, new BigResourceDeser());
    ...
    public BigResource(ResourceType type, String label,
    ...
    public boolean filter(ResourceObject<?> resourceObject) {
        ...
        if (resourceObject.operated() != NameObject.ANY) {
            ...
            if (resType.isGraph()) {
                return this.filter((BigElement) resourceObject.operated());
            }
            if (resType.isAuth()) {
    ...
    private boolean filter(BigElement element) {
        ...
        for (Map.Entry<String, Object> entry : this.properties.entrySet()) {
            ...
            try {
                ...
                throw new BigGraphException("Invalid resource '%s' for '%s': %s",
    ...
    protected boolean contains(BigResource other) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof BigResource)) {
            return false;
        }
        BigResource other = (BigResource) object;
    ...
    public static BigResource parseResource(String resource) {
        return JsonUtil.fromJson(resource, BigResource.class);
    }

    public static List<BigResource> parseResources(String resources) {
        TypeReference<?> type = new TypeReference<List<BigResource>>() {};
    ...
    private static class BigResourceSer extends StdSerializer<BigResource> {

        private static final long serialVersionUID = -138482122210181714L;

        public BigResourceSer() {
            super(BigResource.class);
        }

        @Override
        public void serialize(BigResource res, JsonGenerator generator,
    ...
    private static class BigResourceDeser extends StdDeserializer<BigResource> {

        private static final long serialVersionUID = -2499038590503066483L;

        public BigResourceDeser() {
            super(BigResource.class);
        }

        @Override
        public BigResource deserialize(JsonParser parser,
