...
public class BigUser extends Entity {
    ...
    public BigUser(Id id) {
        this(id, null);
    }

    public BigUser(Id id, String name) {
        this.id = id;
        this.name = name;
        this.role = null;
    }
    ...
    public static BigUser fromVertex(Vertex vertex) {
        BigUser user = new BigUser((Id) vertex.id());
