...
import io.bigconnect.biggraph.auth.BigTarget.P;
...
public abstract class SchemaDefine {
    ...
    public SchemaDefine(BigGraphParams graph, String label) {
        this.graph = graph;
        this.label = label;
    }
    ...
    protected IndexLabel createRangeIndex(VertexLabel label, String field) {
        ...
        IndexLabel indexLabel = schema.indexLabel(name).range()
                                      .on(BigType.VERTEX_LABEL, this.label)
                                      .by(field)
                                      .build();
    ...
    public static abstract class Entity extends AuthElement
                           implements io.bigconnect.biggraph.type.Namifiable {
