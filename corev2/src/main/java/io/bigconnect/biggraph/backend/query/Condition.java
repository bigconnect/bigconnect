...
import io.bigconnect.biggraph.util.Bytes;
...
public abstract class Condition {
    ...
    public abstract boolean test(BigElement element);
    ...
    public static Relation eq(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.EQ, value);
    }

    public static Relation gt(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.GT, value);
    }

    public static Relation gte(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.GTE, value);
    }

    public static Relation lt(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.LT, value);
    }

    public static Relation lte(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.LTE, value);
    }

    public static Relation neq(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.NEQ, value);
    }

    public static Condition in(BigKeys key, List<?> value) {
        return new SyspropRelation(key, RelationType.IN, value);
    }

    public static Condition nin(BigKeys key, List<?> value) {
        return new SyspropRelation(key, RelationType.NOT_IN, value);
    }

    public static Condition prefix(BigKeys key, Id value) {
        return new SyspropRelation(key, RelationType.PREFIX, value);
    }

    public static Condition containsValue(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.CONTAINS_VALUE, value);
    }

    public static Condition containsKey(BigKeys key, Object value) {
        return new SyspropRelation(key, RelationType.CONTAINS_KEY, value);
    }

    public static Condition contains(BigKeys key, Object value) {
    ...
    public static Condition scan(String start, String end) {
        ...
        return new SyspropRelation(BigKeys.ID, RelationType.SCAN, value);
    }
    ...
    public static class SyspropRelation extends Relation {
        ...
        public SyspropRelation(BigKeys key, Object value) {
            this(key, RelationType.EQ, value);
        }

        public SyspropRelation(BigKeys key, RelationType op, Object value) {
    ...
    public static class UserpropRelation extends Relation {
        ...
        @Override
        public boolean test(BigElement element) {
            BigProperty<?> prop = element.getProperty(this.key);
