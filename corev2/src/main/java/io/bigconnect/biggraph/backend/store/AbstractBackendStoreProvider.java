...
import io.bigconnect.biggraph.backend.store.raft.StoreSnapshotFile;
...
public abstract class AbstractBackendStoreProvider
    ...
    @Override
    public void createOlapTable(BigGraph graph, Id pkId) {
    ...
    @Override
    public void initAndRegisterOlapTable(BigGraph graph, Id pkId) {
        String g = graph.option(CoreOptions.STORE_GRAPH);
        BackendStore store = this.stores.get(g);
    ...
    @Override
    public void clearOlapTable(BigGraph graph, Id pkId) {
        String g = graph.option(CoreOptions.STORE_GRAPH);
        BackendStore store = this.stores.get(g);
    ...
    @Override
    public void removeOlapTable(BigGraph graph, Id pkId) {
        String g = graph.option(CoreOptions.STORE_GRAPH);
        BackendStore store = this.stores.get(g);
