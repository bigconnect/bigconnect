...
public class TableDefine {
    ...
    private final Map<BigKeys, String> columns;
    private final List<BigKeys> keys;
    ...
    public TableDefine column(BigKeys key, String... desc) {
    ...
    public Map<BigKeys, String> columns() {
        return Collections.unmodifiableMap(this.columns);
    }

    public Set<BigKeys> columnNames() {
    ...
    public void keys(BigKeys... keys) {
        this.keys.addAll(Arrays.asList(keys));
    }

    public List<BigKeys> keys() {
