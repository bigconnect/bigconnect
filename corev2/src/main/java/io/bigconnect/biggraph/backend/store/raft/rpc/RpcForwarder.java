...
import io.bigconnect.biggraph.backend.store.raft.RaftClosure;
...
import static io.bigconnect.biggraph.backend.store.raft.RaftSharedContext.WAIT_RPC_TIMEOUT;
