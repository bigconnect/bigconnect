...
package io.bigconnect.biggraph.config;

import static io.bigconnect.biggraph.config.OptionChecker.*;
...
public class AuthOptions extends OptionHolder {
    ...
    public static final ConfigOption<String> AUTHENTICATOR =
            new ConfigOption<>(
                    ...
                    "e.g., io.bigconnect.biggraph.auth.StandardAuthenticator, " +
                    "or io.bigconnect.biggraph.auth.ConfigAuthenticator.",
                    null,
                    ""
            );
    ...
    public static final ConfigOption<String> AUTH_GRAPH_STORE =
            new ConfigOption<>(
                    ...
                    "like users, only for io.bigconnect.biggraph.auth.StandardAuthenticator.",
                    disallowEmpty(),
                    "biggraph"
            );
    ...
    public static final ConfigOption<String> AUTH_ADMIN_TOKEN =
            new ConfigOption<>(
                    ...
                    "only for io.bigconnect.biggraph.auth.ConfigAuthenticator.",
                    disallowEmpty(),
    ...
    public static final ConfigListOption<String> AUTH_USER_TOKENS =
            new ConfigListOption<>(
                    ...
                    "only for io.bigconnect.biggraph.auth.ConfigAuthenticator.",
                    disallowEmpty(),
                    "biggraph:9fd95c9c-711b-415b-b85f-d4df46ba5c31"
            );
