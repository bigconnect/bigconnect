...
public class BigConfig extends PropertiesConfiguration {

    private static final Logger LOG = Log.logger(BigConfig.class);

    public BigConfig(Configuration config) {
        if (config == null) {
    ...
    public BigConfig(String configFile) {
