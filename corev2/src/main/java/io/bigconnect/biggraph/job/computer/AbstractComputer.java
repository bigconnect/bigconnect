...
import io.bigconnect.biggraph.util.ParameterUtil;
...
public abstract class AbstractComputer implements Computer {
    ...
    private static final String MAIN_COMMAND =
            "%s/bin/hadoop jar biggraph-computer.jar " +
            "io.bigconnect.biggraph.Computer " +
            "-D libjars=./biggraph-computer-core.jar";
    ...
    public Object call(Job<Object> job, Map<String, Object> parameters) {
        ...
        try {
            ...
            throw new BigGraphException("The computer job exit with code %s: %s",
                                    exitCode, output);
        } catch (BigGraphException e) {
            throw e;
        } catch (Throwable e) {
            throw new BigGraphException("Failed to execute computer job", e);
        }
    }
    ...
    protected static long degree(Map<String, Object> parameters) {
        ...
        BigTraverser.checkDegree(degree);
        return degree;
    }
