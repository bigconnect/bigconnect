...
package io.bigconnect.biggraph.perf;
...
import io.bigconnect.biggraph.func.TriFunction;
import io.bigconnect.biggraph.perf.Stopwatch.Path;
import io.bigconnect.biggraph.testutil.Assert.ThrowableConsumer;
...
public final class PerfUtil {
    ...
    public static void useLightStopwatch(boolean yes) {
        if (yes != LIGHT_WATCH) {
            ...
            io.bigconnect.biggraph.util.E.checkArgument(empty, message);
        }
        LIGHT_WATCH = yes;
    }
    ...
    public void clear() {
        ...
        io.bigconnect.biggraph.util.E.checkState(this.callStack.empty(), error);
    ...
    private void profile(CtMethod ctMethod)
        ...
        final String START =
                "io.bigconnect.biggraph.perf.PerfUtil.instance().start(\"%s\");";
        final String END =
                "io.bigconnect.biggraph.perf.PerfUtil.instance().end(\"%s\");";
