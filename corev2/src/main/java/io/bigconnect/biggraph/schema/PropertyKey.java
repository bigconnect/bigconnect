...
import io.bigconnect.biggraph.type.Propfiable;
import io.bigconnect.biggraph.type.define.AggregateType;
...
public class PropertyKey extends SchemaElement implements Propfiable {
    ...
    public PropertyKey(final BigGraph graph, Id id, String name) {
        super(graph, id, name);
    ...
    public <T> T newValue() {
        ...
        try {
            ...
            throw new BigGraphException("Failed to new instance of %s: %s",
