...
import io.bigconnect.biggraph.type.Indexfiable;
...
public abstract class SchemaLabel extends SchemaElement
    ...
    public SchemaLabel(final BigGraph graph, Id id, String name) {
        super(graph, id, name);
    ...
    public static Id getLabelId(BigGraph graph, BigType type, Object label) {
