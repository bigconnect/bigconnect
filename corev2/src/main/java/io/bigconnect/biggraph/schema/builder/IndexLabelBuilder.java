...
public class IndexLabelBuilder extends AbstractBuilder
    ...
    public IndexLabelBuilder(SchemaTransaction transaction,
                             BigGraph graph, IndexLabel copy) {
        super(transaction, graph);
    ...
    public IndexLabel build() {
        Id id = this.validOrGenerateId(BigType.INDEX_LABEL,
                                       this.id, this.name);
        this.checkBaseType();
        this.checkIndexType();
    ...
    private boolean hasSameProperties(IndexLabel existedIndexLabel) {
        ...
        if ((this.baseType == null &&
             existedIndexLabel.baseType() != BigType.SYS_SCHEMA) ||
            (this.baseType != null &&
    ...
    public SchemaElement.TaskWithSchema createWithTask() {
        BigType type = BigType.INDEX_LABEL;
    ...
    public IndexLabelBuilder onV(String baseValue) {
        this.baseType = BigType.VERTEX_LABEL;
    ...
    public IndexLabelBuilder onE(String baseValue) {
        this.baseType = BigType.EDGE_LABEL;
        this.baseValue = baseValue;
        return this;
    }
    ...
    @Override
    public IndexLabelBuilder on(BigType baseType, String baseValue) {
        E.checkArgument(baseType == BigType.VERTEX_LABEL ||
                        baseType == BigType.EDGE_LABEL,
