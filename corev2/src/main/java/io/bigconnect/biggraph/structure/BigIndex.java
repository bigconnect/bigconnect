...
import io.bigconnect.biggraph.util.HashUtil;
...
public class BigIndex implements GraphType, Cloneable {
    ...
    public BigIndex(BigGraph graph, IndexLabel indexLabel) {
    ...
    @Override
    public BigType type() {
        if (this.indexLabel == IndexLabel.label(BigType.VERTEX)) {
            return BigType.VERTEX_LABEL_INDEX;
        } else if (this.indexLabel == IndexLabel.label(BigType.EDGE)) {
            return BigType.EDGE_LABEL_INDEX;
        }
    ...
    @Override
    public BigIndex clone() {
        try {
            return (BigIndex) super.clone();
        } catch (CloneNotSupportedException e) {
            throw new BigGraphException("Failed to clone HugeIndex", e);
        }
    }

    @Override
    public boolean equals(Object obj) {
        if (!(obj instanceof BigIndex)) {
            return false;
        }

        BigIndex other = (BigIndex) obj;
    ...
    public static Id formatIndexHashId(BigType type, Id indexLabel,
                                       Object fieldValues) {
    ...
    public static Id formatIndexId(BigType type, Id indexLabelId,
                                   Object fieldValues) {
    ...
    public static BigIndex parseIndexId(BigGraph graph, BigType type,
                                        byte[] id) {
        Object values;
