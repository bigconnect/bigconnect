...
import io.bigconnect.biggraph.concurrent.PausableScheduledThreadPool;
...
public final class TaskManager {
    ...
    private final Map<BigGraphParams, TaskScheduler> schedulers;
    ...
    public void addScheduler(BigGraphParams graph) {
    ...
    public void closeScheduler(BigGraphParams graph) {
    ...
    private void closeTaskTx(BigGraphParams graph) {
        ...
        try {
            ...
            throw new BigGraphException("Exception when closing task tx", e);
        }
    }

    private void closeSchedulerTx(BigGraphParams graph) {
        ...
        try {
            ...
            throw new BigGraphException("Exception when closing scheduler tx", e);
        }
    }
    ...
    public TaskScheduler getScheduler(BigGraphParams graph) {
        return this.schedulers.get(graph);
    }

    public ServerInfoManager getServerInfoManager(BigGraphParams graph) {
    ...
    public void shutdown(long timeout) {
        ...
        if (ex != null) {
            throw new BigGraphException("Failed to wait for TaskScheduler", ex);
        }
    }
    ...
    protected void notifyNewTask(BigTask<?> task) {
