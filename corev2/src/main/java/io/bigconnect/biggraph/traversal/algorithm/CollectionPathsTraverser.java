...
public class CollectionPathsTraverser extends BigTraverser {

    public CollectionPathsTraverser(BigGraph graph) {
        super(graph);
    }
    ...
    private class NearestTraverser extends Traverser {
        ...
        public NearestTraverser(BigTraverser traverser,
