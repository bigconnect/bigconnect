...
public class CustomizedCrosspointsTraverser extends BigTraverser {

    public CustomizedCrosspointsTraverser(BigGraph graph) {
        super(graph);
    }
    ...
    public CrosspointsPaths crosspointsPaths(Iterator<Vertex> vertices,
        ...
        List<BigVertex> verticesList = newList();
    ...
    private static CrosspointsPaths intersectionPaths(List<BigVertex> sources,
                                                      List<Path> paths,
                                                      long limit) {
        ...
        Set<Id> sourceIds = sources.stream().map(BigVertex::id)
    ...
    public static class Step {
        ...
        public Step(BigGraph g, Directions direction, List<String> labels,
