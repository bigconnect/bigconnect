...
import io.bigconnect.biggraph.util.OrderLimitMap;
...
public class NeighborRankTraverser extends BigTraverser {
    ...
    public NeighborRankTraverser(BigGraph graph, double alpha, long capacity) {
        super(graph);
