...
public class PersonalRankTraverser extends BigTraverser {

    private final double alpha;
    private final long degree;
    private final int maxDepth;

    public PersonalRankTraverser(BigGraph graph, double alpha,
    ...
    private Directions getStartDirection(Id source, String label) {
        ...
        BigVertex vertex = (BigVertex) graph().vertices(source).next();
