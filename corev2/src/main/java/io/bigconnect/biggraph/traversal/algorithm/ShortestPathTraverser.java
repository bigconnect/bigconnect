...
import io.bigconnect.biggraph.traversal.algorithm.records.ShortestPathRecords;
...
public class ShortestPathTraverser extends BigTraverser {

    public ShortestPathTraverser(BigGraph graph) {
        super(graph);
    }
