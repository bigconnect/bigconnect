...
public class SingleSourceShortestPathTraverser extends BigTraverser {

    public SingleSourceShortestPathTraverser(BigGraph graph) {
        super(graph);
    }
    ...
    private class Traverser {
        ...
        private double edgeWeight(BigEdge edge) {
            double edgeWeight;
            if (this.weight == null ||
