...
import io.bigconnect.biggraph.traversal.algorithm.steps.RepeatEdgeStep;
...
public class TemplatePathsTraverser extends BigTraverser {

    public TemplatePathsTraverser(BigGraph graph) {
        super(graph);
    }
    ...
    public Set<Path> templatePaths(Iterator<Vertex> sources,
        ...
        while (sources.hasNext()) {
            sourceList.add(((BigVertex) sources.next()).id());
        }
        ...
        while (targets.hasNext()) {
            targetList.add(((BigVertex) targets.next()).id());
        }
    ...
    private static class Traverser extends PathTraverser {
        ...
        public Traverser(BigTraverser traverser, TraverseStrategy strategy,
