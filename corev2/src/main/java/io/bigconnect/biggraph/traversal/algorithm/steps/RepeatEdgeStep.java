...
public class RepeatEdgeStep extends EdgeStep {
    ...
    public RepeatEdgeStep(BigGraph g, Directions direction) {
        this(g, direction, ImmutableList.of());
    }

    public RepeatEdgeStep(BigGraph g, Directions direction, int maxTimes) {
        this(g, direction);
        this.maxTimes = maxTimes;
    }

    public RepeatEdgeStep(BigGraph g, List<String> labels) {
        this(g, Directions.BOTH, labels);
    }

    public RepeatEdgeStep(BigGraph g, List<String> labels, int maxTimes) {
        this(g, labels);
        this.maxTimes = maxTimes;
    }

    public RepeatEdgeStep(BigGraph g, Map<String, Object> properties) {
