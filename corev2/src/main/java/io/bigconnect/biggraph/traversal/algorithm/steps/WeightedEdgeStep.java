...
import static io.bigconnect.biggraph.traversal.algorithm.BigTraverser.*;
...
public class WeightedEdgeStep {
    ...
    public WeightedEdgeStep(BigGraph g, Directions direction) {
        this(g, direction, ImmutableList.of());
    }

    public WeightedEdgeStep(BigGraph g, List<String> labels) {
        this(g, Directions.BOTH, labels);
    }

    public WeightedEdgeStep(BigGraph g, Map<String, Object> properties) {
        this(g, Directions.BOTH, ImmutableList.of(), properties);
    }

    public WeightedEdgeStep(BigGraph g, Directions direction, List<String> labels) {
