...
public final class BigGraphStepStrategy
    ...
    private static final BigGraphStepStrategy INSTANCE;

    static {
        INSTANCE = new BigGraphStepStrategy();
    }

    private BigGraphStepStrategy() {
        // pass
    }
    ...
    public void apply(Traversal.Admin<?, ?> traversal) {
        ...
        for (GraphStep originStep : steps) {
            BigGraphStep<?, ?> newStep = new BigGraphStep<>(originStep);
    ...
    public Set<Class<? extends ProviderOptimizationStrategy>> applyPost() {
        return Collections.singleton(BigCountStepStrategy.class);
    }

    public static BigGraphStepStrategy instance() {
        return INSTANCE;
    }
}
