 ...
 */
public final class BigScriptTraversal<S, E> extends DefaultTraversal<S, E> {
    ...
    public BigScriptTraversal(TraversalSource traversalSource,
    ...
    public void applyStrategies() throws IllegalStateException {
        ...
        try {
            ...
            throw new BigGraphException(e.getMessage(), e);
        }
    }
}
