...
public final class Consumers<V> {
    ...
    public void await() throws Throwable {
        ...
        if (this.executor == null) {
            ...
            try {
                ...
                this.exception = new BigGraphException(error, e);
                LOG.warn(error, e);
            }
        }
    ...
    public static RuntimeException wrapException(Throwable e) {
        ...
        throw new BigGraphException("Error when running task: %s",
                                BigGraphException.rootCause(e).getMessage(), e);
    }
    ...
    public static class StopExecution extends BigGraphException {
