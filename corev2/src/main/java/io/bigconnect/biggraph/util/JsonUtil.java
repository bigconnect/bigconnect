...
package io.bigconnect.biggraph.util;
...
import io.bigconnect.biggraph.io.BigGraphSONModule;
...
public final class JsonUtil {
    ...
    static {
        ...
        BigGraphSONModule.registerCommonSerializers(module);
        BigGraphSONModule.registerIdSerializers(module);
        BigGraphSONModule.registerSchemaSerializers(module);
        BigGraphSONModule.registerGraphSerializers(module);
    ...
    public static String toJson(Object object) {
        try {
            ...
            throw new BigGraphException("Can't write json: %s", e, e.getMessage());
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz) {
        ...
        try {
            ...
            throw new BigGraphException("Can't read json: %s", e, e.getMessage());
        }
    }
