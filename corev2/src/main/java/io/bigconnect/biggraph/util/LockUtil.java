...
import io.bigconnect.biggraph.concurrent.KeyLock;
import io.bigconnect.biggraph.concurrent.LockManager;
import io.bigconnect.biggraph.concurrent.RowLock;
...
public final class LockUtil {
    ...
    public static String hugeType2Group(BigType type) {
        switch (type) {
            case PROPERTY_KEY:
