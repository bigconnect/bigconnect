...
public final class StringEncoding {
    ...
    static {
        ...
        try {
            ...
            throw new BigGraphException("Failed to load algorithm %s", e, ALG);
        }
    }
    ...
    public static byte[] encode(String value) {
        try {
            ...
            throw new BigGraphException("Failed to encode string", e);
        }
    }
    ...
    public static String decode(byte[] bytes) {
        try {
            ...
            throw new BigGraphException("Failed to decode string", e);
        }
    }
