...
import com.mware.ge.cypher.util.StringFunction;
...
public interface TokenNameLookup {
     ...
     */
    String labelGetName(String labelId);

    /**
     * @param relationshipTypeId id of relationship type to get name for.
     * @return name of relationship type token with given id.
     */
    String relationshipTypeGetName(String relationshipTypeId);

    /**
     * @param propertyKeyId id of property key to get name for.
     * @return name of property key token with given id.
     */
    String propertyKeyGetName(String propertyKeyId);

    default String[] entityTokensGetNames(ElementType type, String[] entityTokenIds) {
        StringFunction<String> mapper;
        switch (type) {
            case VERTEX:
