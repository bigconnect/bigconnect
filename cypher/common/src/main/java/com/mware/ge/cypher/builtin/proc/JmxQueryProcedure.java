...
import com.mware.ge.collection.CollectorsUtil;
...
import static com.mware.ge.collection.MapUtil.map;
        ...
        try {
            ...
            throw new ProcedureException(Status.Procedure.ProcedureCallFailed,
                    "'%s' is an invalid JMX name pattern. Valid queries should use" +
                            ...
                            "For instance, try 'metrics:*' to find the BigConnect JMX metrics " +
