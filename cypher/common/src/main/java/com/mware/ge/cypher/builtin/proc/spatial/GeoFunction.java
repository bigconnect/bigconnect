...
public abstract class GeoFunction<T extends AnyValue> implements CallableUserFunction {

    public static void registerGeoFunctions( Procedures procedures, ProcedureConfig procedureConfig ) throws ProcedureException {
        procedures.register( new ToGeoPoint() );
    }
