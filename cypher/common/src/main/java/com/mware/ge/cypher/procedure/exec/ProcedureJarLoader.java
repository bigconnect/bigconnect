...
import com.mware.ge.cypher.procedure.impl.CallableUserAggregationFunction;
...
public class ProcedureJarLoader {
    private static BcLogger log = BcLoggerFactory.getLogger(ProcedureJarLoader.class);

    private final ReflectiveProcedureCompiler compiler;

    ProcedureJarLoader(ReflectiveProcedureCompiler compiler) {
