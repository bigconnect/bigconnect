...
public class Procedures extends LifecycleAdapter {
     ...
     */
    public Procedures() {
        this(new SpecialBuiltInProcedures(), null, ProcedureConfig.DEFAULT);
    }
    ...
    public Procedures(
        ...
        this.compiler = new ReflectiveProcedureCompiler(typeMappers, safeComponents, allComponents, config);
    }
    ...
    public void start() throws Throwable {
        ...
        ProcedureJarLoader loader = new ProcedureJarLoader(compiler);
