...
import com.mware.ge.cypher.exception.ComponentInjectionException;
import com.mware.ge.cypher.exception.Status;
import com.mware.ge.cypher.procedure.*;
...
import com.mware.ge.cypher.procedure.exec.OutputMappers.OutputMapper;
import com.mware.ge.values.AnyValue;
...
import static com.mware.ge.collection.Iterators.asRawIterator;
import static com.mware.ge.cypher.exception.AuthorizationViolationException.PERMISSION_DENIED;
...
class ReflectiveProcedureCompiler {
    private static BcLogger log = BcLoggerFactory.getLogger(ReflectiveProcedureCompiler.class);
    ...
    ReflectiveProcedureCompiler(TypeMappers typeMappers, ComponentRegistry safeComponents,
                                ComponentRegistry allComponents, ProcedureConfig config) {
        this(
    ...
    private String describeAndLogLoadFailure(QualifiedName name) {
        ...
        String description =
                nameStr + " is unavailable because it is sandboxed and has dependencies outside of the sandbox. " +
                        "Sandboxing is controlled by the procedure_unrestricted setting. " +
