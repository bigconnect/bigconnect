...
public interface QueryExecutionEngine {
    Result executeQuery(String query, MapValue parameters, GeCypherQueryContext context)
            throws QueryExecutionKernelException;

    Result profileQuery(String query, MapValue parameters, GeCypherQueryContext context)
            throws QueryExecutionKernelException;
