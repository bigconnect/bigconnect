...
public interface SchemaDescriptor extends SchemaDescriptorSupplier {
    SchemaDescriptor NO_SCHEMA = new SchemaDescriptor() {
        @Override
        public boolean isAffected(String[] entityIds) {
            return false;
        }
    ...
    static String[] schemaTokenLockingIds(SchemaDescriptor schema) {
    ...
    static String[] schemaTokenLockingIds(String[] tokenIds) {
        String[] lockingIds = new String[tokenIds.length];
     ...
     */
    boolean isAffected(String[] entityTokenIds);
