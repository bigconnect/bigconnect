...
public class SchemaDescriptorFactory {
    ...
    public static LabelSchemaDescriptorImpl forLabel(String labelId, String... propertyIds) {
        validateLabelIds(labelId);
        validatePropertyIds(propertyIds);
        return new LabelSchemaDescriptorImpl(labelId, propertyIds);
    }


    private static void validatePropertyIds(String[] propertyIds) {
    ...
    private static void validateRelationshipTypeIds(String... relTypes) {
    ...
    private static void validateLabelIds(String... labelIds) {
