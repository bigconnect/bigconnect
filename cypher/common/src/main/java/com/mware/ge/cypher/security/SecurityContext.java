 ...
 */
package com.mware.ge.cypher.security;
...
public class SecurityContext implements LoginContext
{
    ...
    public SecurityContext(AuthSubject subject, AccessMode mode, Authorizations authorizations )
    {
    ...
    private static class AuthDisabled extends SecurityContext
    {
        ...
        {
            super( AuthSubject.AUTH_DISABLED, mode, new Authorizations() );
        }
