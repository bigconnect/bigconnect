...
public class DefaultValueMapper extends ValueMapper.JavaMapper {
    ...
    @Override
    public VirtualNodeValue mapNode(VirtualNodeValue value) {
        assert !(value instanceof NodeReference);
        return value;
    }

    @Override
    public VirtualRelationshipValue mapRelationship(VirtualRelationshipValue value) {
        assert !(value instanceof RelationshipReference);
        return value;
    }

    @Override
    public PathValue mapPath(PathValue value) {
        return value;
    }
}
