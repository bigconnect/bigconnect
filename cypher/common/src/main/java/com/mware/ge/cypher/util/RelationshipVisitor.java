 ...
 *
 * @param <EXCEPTION> exception thrown from the {@link #visit(String, int, String, String)} method.
 */
public interface RelationshipVisitor<EXCEPTION extends Exception> {
     ...
     */
    interface Home {
        <EXCEPTION extends Exception> boolean relationshipVisit(String relId,
     ...
     */
    void visit(String relationshipId, int typeId, String startNodeId, String endNodeId) throws EXCEPTION;
}
