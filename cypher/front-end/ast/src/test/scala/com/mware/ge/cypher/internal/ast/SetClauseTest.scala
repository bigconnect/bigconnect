...
import com.mware.ge.cypher.internal.ast.semantics.{SemanticFunSuite, SemanticState}
...
class SetClauseTest extends SemanticFunSuite {
  ...
  test("shouldHaveMergedTypesOfAllAlternativesInSimpleCase") {
    ...
    val setItem = SetPropertyItem(property, expressions.DummyExpression(CTAny))(DummyPosition(42))
