...
import com.mware.ge.cypher.internal.expressions.{Namespace => ASTNamespace}
import com.mware.ge.cypher.internal.util.{InputPosition, InternalException, SyntaxException}
