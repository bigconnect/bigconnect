...
import com.mware.ge.cypher.internal.{expressions => exp}
import com.mware.ge.cypher.internal.util.InputPosition
import com.mware.ge.cypher.internal.util.test_helpers.TestName
...
trait ParserAstTest[AST] extends ParserTest[AST, AST] with TestName {
  ...
  private type Expression = (InputPosition) => com.mware.ge.cypher.internal.expressions.Expression

  final def id(id: String): (InputPosition) => com.mware.ge.cypher.internal.expressions.Variable = exp.Variable(id)(_)
