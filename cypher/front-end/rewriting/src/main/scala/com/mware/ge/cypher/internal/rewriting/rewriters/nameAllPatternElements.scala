...
import com.mware.ge.cypher.internal.expressions.{NodePattern, RelationshipPattern, Variable}
import com.mware.ge.cypher.internal.util.{Rewriter, UnNamedNameGenerator, bottomUp}
