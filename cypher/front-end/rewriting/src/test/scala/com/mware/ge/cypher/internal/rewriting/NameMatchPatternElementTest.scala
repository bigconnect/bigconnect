...
import com.mware.ge.cypher.internal.rewriting.rewriters.{nameMatchPatternElements, nameUpdatingClauses}
...
class NameMatchPatternElementTest extends CypherFunSuite {
  ...
  import com.mware.ge.cypher.internal.parser.ParserFixture._
