 ...
 */
package com.mware.ge.cypher.internal.ir.helpers

import com.mware.ge.cypher.internal.util.{Rewriter, topDown}
import com.mware.ge.cypher.internal.rewriting.rewriters.{LabelPredicateNormalizer, MatchPredicateNormalizerChain, PropertyPredicateNormalizer, addUniquenessPredicates}

import com.mware.ge.cypher.internal.expressions.{Ands, Expression, HasLabels, Not, Ors, PatternComprehension, PatternExpression, RelationshipChain, Variable}
import com.mware.ge.cypher.internal.util.UnNamedNameGenerator._
import com.mware.ge.cypher.internal.ir._
import com.mware.ge.cypher.internal.ir.helpers.PatternConverters._
import com.mware.ge.cypher.internal.ir.QueryGraph
import com.mware.ge.cypher.internal.expressions.Range
