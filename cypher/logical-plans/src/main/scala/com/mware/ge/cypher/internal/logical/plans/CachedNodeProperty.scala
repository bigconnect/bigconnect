...
import com.mware.ge.cypher.internal.ast.semantics.{SemanticCheck, SemanticCheckResult, SemanticCheckableExpression}
import com.mware.ge.cypher.internal.expressions.{Expression => ASTExpression, PropertyKeyName}
