...
object IndexSeek {
  ...
  def apply(indexSeekString: String,
            ...
            propIds: Map[String, String] = Map.empty,
            labelId: String = "")(implicit idGen: IdGen): IndexLeafPlan = {
    ...
    def prop(prop: String) = {
      IndexedProperty(PropertyKeyToken(PropertyKeyName(prop)(pos), PropertyKeyId(prop)), getValue)
    }
