...
import com.mware.ge.cypher.internal.ir.Strictness
...
final case class SchemaIndexSeekUsage(identifier: String, labelId : String, label: String, propertyKeys: Seq[String]) extends IndexUsage
final case class SchemaIndexScanUsage(identifier: String, labelId : String, label: String, propertyKey: String) extends IndexUsage
