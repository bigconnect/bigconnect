...
import com.mware.ge.cypher.internal.ast.RelationshipStartItem
import com.mware.ge.cypher.internal.ast.semantics.SemanticTable
import com.mware.ge.cypher.internal.ir._
import com.mware.ge.cypher.internal.util.UnNamedNameGenerator
...
case class PlannerQueryBuilder(private val q: PlannerQuery, semanticTable: SemanticTable, returns: Seq[String] = Seq.empty)
  ...
  def build(): PlannerQuery = {
    ...
    def groupInequalities(plannerQuery: PlannerQuery): PlannerQuery = {
      import com.mware.ge.cypher.internal.util.NonEmptyList._
