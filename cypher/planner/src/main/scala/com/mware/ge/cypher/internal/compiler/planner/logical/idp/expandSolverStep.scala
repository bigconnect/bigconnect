...
import com.mware.ge.cypher.internal.compiler.planner.logical.steps.PatternExpressionSolver
import com.mware.ge.cypher.internal.ir._
import com.mware.ge.cypher.internal.logical.plans.{ExpandAll, ExpandInto, LogicalPlan}
import com.mware.ge.cypher.internal.expressions.{Ands, Expression, LogicalVariable}

case class expandSolverStep(qg: QueryGraph) extends IDPSolverStep[PatternRelationship, LogicalPlan, LogicalPlanningContext] {

  import com.mware.ge.cypher.internal.compiler.planner.logical.idp.expandSolverStep._
