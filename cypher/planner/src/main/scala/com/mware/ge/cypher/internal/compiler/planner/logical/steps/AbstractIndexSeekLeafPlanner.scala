...
import com.mware.ge.cypher.internal.compiler.IndexLookupUnfulfillableNotification
import com.mware.ge.cypher.internal.compiler.planner.logical.LeafPlansForVariable.maybeLeafPlans
import com.mware.ge.cypher.internal.compiler.planner.logical.ordering.ResultOrdering
import com.mware.ge.cypher.internal.compiler.planner.logical.plans._
import com.mware.ge.cypher.internal.compiler.planner.logical.{LeafPlanFromExpressions, LeafPlanner, LeafPlansForVariable, LogicalPlanningContext}
...
abstract class AbstractIndexSeekLeafPlanner extends LeafPlanner with LeafPlanFromExpressions {
  ...
  protected def findIndexesForLabel(labelId: String, context: LogicalPlanningContext): Iterator[IndexDescriptor]
