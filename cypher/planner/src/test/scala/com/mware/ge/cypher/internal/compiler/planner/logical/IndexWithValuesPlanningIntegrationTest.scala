...
import com.mware.ge.cypher.internal.util.symbols.CTString
        ...
        Distinct(
          Union(
            ...
            Selection(Ands(Set(GreaterThan(prop("n", "prop2"), SignedDecimalIntegerLiteral("3")(pos))(pos)))(pos),
              IndexSeek("n:Awesome(prop2)", CanGetValue, propIds = Map("prop2" -> "prop2")))
          ),
  ...
  test("in an OR index plan should not get values for equality predicates") {
    ...
    plan._2 should equal(
      Projection(
        Distinct(
          Union(
            IndexSeek("n:Awesome(prop2 = 3)", CanGetValue, propIds = Map("prop2" -> "prop2")),
            IndexSeek("n:Awesome(prop1 = 42)", CanGetValue, propIds = Map("prop1" -> "prop1"))
          ),
          Map("n" -> Variable("n")(pos))
        ),
        Map("n.prop1" -> Property(Variable("n")(pos), PropertyKeyName("prop1")(pos))(pos), "n.prop2" -> Property(Variable("n")(pos), PropertyKeyName("prop2")(pos))(pos))
          ...
          Distinct(
            Union(
              Union(
                Union(
                  IndexSeek("n:Awesome(prop2 = 3)", CanGetValue, propIds = Map("prop2" -> "prop2")),
                  IndexSeek("n:Awesome2(prop2 = 3)", CanGetValue, propIds = Map("prop2" -> "prop2"), labelId = "Awesome2")
                ),
                IndexSeek("n:Awesome(prop1 = 42)", CanGetValue, propIds = Map("prop1" -> "prop1"))
              ),
              IndexSeek("n:Awesome2(prop1 = 42)", CanGetValue, propIds = Map("prop1" -> "prop1"), labelId = "Awesome2")
            ),
            Map("n" -> Variable("n")(pos))
          )
        ),
      ...
      Projection(
        Expand(
          Projection(
            NodeIndexSeek(
              "n",
              LabelToken("Awesome", LabelId("Awesome")),
              Seq(IndexedProperty(PropertyKeyToken(PropertyKeyName("prop") _, PropertyKeyId("prop")), GetValue)),
        ...
        Expand(
          Projection(
            NodeIndexSeek(
              "  n@7",
              LabelToken("Awesome", LabelId("Awesome")),
              Seq(IndexedProperty(PropertyKeyToken(PropertyKeyName("prop") _, PropertyKeyId("prop")), DoNotGetValue)),
              SingleQueryExpression(SignedDecimalIntegerLiteral("42") _),
              Set.empty,
              IndexOrderNone),
    ...
    plan._2 should equal(
      Projection(
        NodeIndexSeek(
          "n",
          LabelToken("Awesome", LabelId("Awesome")),
          Seq(IndexedProperty(PropertyKeyToken(PropertyKeyName("prop") _, PropertyKeyId("prop")), GetValue), IndexedProperty(PropertyKeyToken(PropertyKeyName("foo") _, PropertyKeyId("foo")), DoNotGetValue)),
    ...
    plan._2 should equal(
      Projection(
        NodeIndexScan(
          "n",
          LabelToken("Awesome", LabelId("Awesome")),
          IndexedProperty(PropertyKeyToken(PropertyKeyName("prop") _, PropertyKeyId("prop")), GetValue),
          Set.empty,
          IndexOrderNone),
        Map(cachedNodePropertyProj("n", "prop"))
      )
    ...
    plan._2 should equal(
      Projection(
        NodeIndexScan(
          "n",
          LabelToken("Awesome", LabelId("Awesome")),
          IndexedProperty(PropertyKeyToken(PropertyKeyName("prop") _, PropertyKeyId("prop")), DoNotGetValue),
          Set.empty,
          IndexOrderNone),
        Map(propertyProj("n", "prop"))
      )
