...
import com.mware.ge.cypher.internal.compiler.planner.logical.Metrics
...
trait CardinalityModelTestHelper extends CardinalityTestHelper {
  ...
  implicit class RichTestUnit(testUnit: CardinalityTestHelper#TestUnit) {
    def shouldHaveQueryGraphCardinality(number: Double) {
      ...
      import com.mware.ge.cypher.internal.compiler.planner.logical.CardinalitySupport.Eq
      ...
      val result = cardinalityModel(queryGraph, input, rewrittenSemanticTable, null)
