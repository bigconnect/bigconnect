...
import com.mware.ge.cypher.internal.ir.{PatternRelationship, QueryGraph, SimplePatternLength}
...
import com.mware.ge.cypher.internal.expressions.{PropertyKeyName, SemanticDirection}
