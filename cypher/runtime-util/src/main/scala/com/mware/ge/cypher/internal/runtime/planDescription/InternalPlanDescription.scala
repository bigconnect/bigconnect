...
import com.mware.ge.cypher.internal.runtime.planDescription.InternalPlanDescription.Arguments._
import com.mware.ge.cypher.internal.expressions.SemanticDirection
import com.mware.ge.cypher.internal.logical.plans.{QualifiedName, SeekableArgs}
...
import com.mware.ge.cypher.ExecutionPlanDescription.ProfilerStatistics
...
/**
  ...
  */
sealed trait InternalPlanDescription extends ExecutionPlanDescription {
  self =>
  ...
  override def getChildren: util.List[ExecutionPlanDescription] = {
    val childPlans: Seq[ExecutionPlanDescription] = exceptionHandler.runSafely {
