...
import com.mware.ge.cypher.QueryExecutionType.QueryType;
...
import com.mware.ge.cypher.query.QueryExecutionEngine;
import com.mware.ge.cypher.query.QueryExecutionKernelException;
 ...
 * The result objects could be {@link com.mware.ge.Vertex Nodes},
 * {@link com.mware.ge.Edge Relationships} or java primitives.
 * <p>
 * <p>
...
public class ExecutionResult implements ResourceIterable<Map<String, Object>>, Result, QueryResultProvider {
     ...
     * returned from calling {@link QueryExecutionEngine#executeQuery(String, MapValue, GeCypherQueryContext)} )}.
     *
