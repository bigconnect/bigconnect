...
/**
  ...
  *
  *   'CYPHER 4.0 planner=cost,runtime=slotted MATCH (n) RETURN n'
  *
  * into
  *
  * PreParsedQuery(
...
class PreParser(configuredVersion: CypherVersion,
  ...
  private final val ILLEGAL_PLANNER_VERSION_COMBINATIONS: Set[(CypherPlannerOption, CypherVersion)] = Set((CypherPlannerOption.rule, CypherVersion.v4_0))
  ...
  /**
    ...
    * @throws com.mware.ge.cypher.SyntaxException if there are syntactic errors in the pre-parser options
