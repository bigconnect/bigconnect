...
import com.mware.ge.cypher.internal.compatibility.runtime.helpers.MapBasedRow
...
import com.mware.ge.cypher.result.{QueryResult, RuntimeResult}
...
import com.mware.ge.cypher.internal.util.{ProfilerStatisticsNotReadyException, TaskCloser}
...
class StandardInternalExecutionResult(context: QueryContext,
  ...
  override def dumpToString(): String = {
    val resultStringBuilder = ResultStringBuilder(fieldNames(), context)
