...
import com.mware.ge.cypher.util.StringIterator
...
object PrimitiveLongHelper {
  ...
  def mapStringPrimitive(in: StringIterator, f: String => String): StringIterator = new StringIterator {
    override def next(): String = f(in.next())
