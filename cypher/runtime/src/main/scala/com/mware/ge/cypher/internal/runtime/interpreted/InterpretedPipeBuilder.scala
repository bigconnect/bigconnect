...
import com.mware.ge.cypher.internal.ir.VarPatternLength
import com.mware.ge.cypher.internal.runtime.ProcedureCallMode
import com.mware.ge.cypher.internal.runtime.interpreted.commands.KeyTokenResolver
import com.mware.ge.cypher.internal.runtime.interpreted.commands.convert.PatternConverters._
import com.mware.ge.cypher.internal.runtime.interpreted.commands.convert.{ExpressionConverters, InterpretedCommandProjection}
import com.mware.ge.cypher.internal.runtime.interpreted.commands.expressions.{AggregationExpression, Literal, ShortestPathExpression}
import com.mware.ge.cypher.internal.runtime.interpreted.commands.predicates.{Predicate, True}
import com.mware.ge.cypher.internal.runtime.interpreted.pipes.{QueryState, _}
import com.mware.ge.cypher.internal.logical.plans
import com.mware.ge.cypher.internal.logical.plans.{ActiveRead, Aggregation}
import com.mware.ge.cypher.internal.logical.plans.{ColumnOrder, Limit => LimitPlan, LoadCSV => LoadCSVPlan, Skip => SkipPlan, _}
...
import com.mware.ge.cypher.internal.expressions.{Equals => ASTEquals, Expression => ASTExpression, _}
import com.mware.ge.cypher.internal.util.attribution.Id
import com.mware.ge.cypher.internal.util.{Eagerly, InternalException}
...
case class InterpretedPipeBuilder(recurse: LogicalPlan => Pipe,
  ...
  private def translateColumnOrder(s: ColumnOrder): com.mware.ge.cypher.internal.runtime.interpreted.pipes.ColumnOrder = s match {
    case plans.Ascending(name) => com.mware.ge.cypher.internal.runtime.interpreted.pipes.Ascending(name)
    case plans.Descending(name) => com.mware.ge.cypher.internal.runtime.interpreted.pipes.Descending(name)
  }
}
