...
trait CachingExpandInto {
  ...
  protected def findRelationships(query: QueryContext, fromNode: NodeValue, toNode: NodeValue,
                                relCache: RelationshipsCache, dir: SemanticDirection, relTypes: => Option[Array[String]]): Iterator[RelationshipValue] = {
  ...
  private def relIterator(query: QueryContext, fromNode: NodeValue,  toNode: NodeValue, preserveDirection: Boolean,
                          relTypes: Option[Array[String]], relCache: RelationshipsCache, dir: SemanticDirection) = {
  ...
  private def getDegree(node: NodeValue, relTypes: Option[Array[String]], direction: SemanticDirection, query: QueryContext) = {
    relTypes.map {
  ...
  protected final class RelationshipsCache(capacity: Int) {
    ...
    val table = new mutable.OpenHashMap[(String, String), Seq[RelationshipValue]]()
