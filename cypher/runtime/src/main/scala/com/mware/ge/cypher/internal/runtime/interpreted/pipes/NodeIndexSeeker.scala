...
import com.mware.ge.cypher.internal.runtime.interpreted.commands.expressions.{Expression, InequalitySeekRangeExpression, PointDistanceSeekRangeExpression, PrefixSeekRangeExpression}
import com.mware.ge.cypher.internal.runtime.interpreted.{ExecutionContext, IsList, makeValueNeoSafe}
import com.mware.ge.cypher.internal.logical.plans._
import com.mware.ge.values.storable.{GeoPointValue, _}
import com.mware.ge.cypher.internal.frontend.helpers.SeqCombiner.combine
import com.mware.ge.cypher.internal.util.{CypherTypeException, InternalException}
        ...
        rangeWrapper match {
          ...
          case PointDistanceSeekRangeExpression(range) =>
            ...
            (valueRange.distance, valueRange.point) match {
              case (distance: NumberValue, point: GeoPointValue) =>
