...
object SetOperation {
  ...
  private def propertyKeyMap(qtx: QueryContext, map: MapValue): Map[String, AnyValue] = {
    val builder = Map.newBuilder[String, AnyValue]
...
abstract class AbstractSetPropertyOperation extends SetOperation {
  ...
  protected def setProperty[T](context: ExecutionContext, state: QueryState, ops: Operations[T],
                                                    itemId: String, propertyKey: LazyPropertyKey,
...
abstract class SetEntityPropertyOperation[T](itemName: String, propertyKey: LazyPropertyKey,
  ...
  protected def id(item: Any): String

  protected def operations(qtx: QueryContext): Operations[T]

  protected def invalidateCachedProperties(executionContext: ExecutionContext, id: String): Unit
...
case class SetNodePropertyOperation(nodeName: String, propertyKey: LazyPropertyKey,
  ...
  override protected def invalidateCachedProperties(executionContext: ExecutionContext, id: String): Unit =
...
case class SetRelationshipPropertyOperation(relName: String, propertyKey: LazyPropertyKey,
  ...
  override protected def invalidateCachedProperties(executionContext: ExecutionContext, id: String): Unit = {} // we do not cache relationships
}
...
abstract class SetPropertyFromMapOperation[T](itemName: String, expression: Expression,
  ...
  private def setPropertiesFromMap(qtx: QueryContext, ops: Operations[T], itemId: String,
                                   map: Map[String, AnyValue], removeOtherProps: Boolean) {
