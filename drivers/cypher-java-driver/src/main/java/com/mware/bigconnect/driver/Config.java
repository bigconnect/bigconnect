...
import static com.mware.bigconnect.driver.Config.TrustStrategy.trustSystemCertificates;
import static com.mware.bigconnect.driver.Logging.javaUtilLogging;
...
public class Config
{
    ...
    /**
     * @return the strategy to use to determine the authenticity of an encryption certificate provided by the BigConnect instance we are connecting to.
     */
    ...
    public static class ConfigBuilder
    {
         ...
         *  URI with 'bolt+routing' or 'bc' scheme.
         * <p>
        ...
        /**
         * Specify how to determine the authenticity of an encryption certificate provided by the BigConnect instance we are connecting to.
         ...
         * is really BigConnect, there is no point to encrypt at all, since anyone could pretend to be the remote BigConnect instance.
         * <p>
    ...
    /**
     * Control how the driver determines if it can trust the encryption certificates provided by the BigConnect instance it is connected to.
     */
    public static class TrustStrategy
    {
        ...
        /**
         * Only encrypted connections to BigConnect instances with certificates signed by a trusted certificate will be accepted.
