...
import com.mware.bigconnect.driver.internal.InternalIsoDuration;
...
import static com.mware.bigconnect.driver.internal.util.Extract.assertParameter;
...
public abstract class Values
{
    ...
    public static Value value( Object value )
    {
        ...
        throw new ClientException( "Unable to convert " + value.getClass().getName() + " to BigConnect Value." );
    }
    ...
    /**
     * Converts values to {@link String entity id}.
     *
     * @return a function that returns the id an entity {@link Value}
     */
    public static Function<Value, String> ofEntityId()
    {
