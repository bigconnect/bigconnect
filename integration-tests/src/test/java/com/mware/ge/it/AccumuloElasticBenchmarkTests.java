...
public class AccumuloElasticBenchmarkTests extends AccumuloBenchmarkTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticBenchmarkTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloBenchmarkTests.accumuloResource = accumuloResource;
        super.before();
    }
