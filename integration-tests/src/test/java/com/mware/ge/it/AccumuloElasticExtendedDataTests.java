...
import com.mware.ge.accumulo.AccumuloBenchmarkTests;
import com.mware.ge.accumulo.AccumuloExtendedDataTests;
...
public class AccumuloElasticExtendedDataTests extends AccumuloExtendedDataTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticExtendedDataTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloExtendedDataTests.accumuloResource = accumuloResource;
        super.before();
    }
