...
import com.mware.ge.accumulo.AccumuloFetchHintsTests;
...
public class AccumuloElasticFetchHintsTests extends AccumuloFetchHintsTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticFetchHintsTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloFetchHintsTests.accumuloResource = accumuloResource;
        super.before();
    }
