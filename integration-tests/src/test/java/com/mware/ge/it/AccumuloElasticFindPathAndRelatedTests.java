...
import com.mware.ge.accumulo.AccumuloFindPathAndRelatedTests;
...
public class AccumuloElasticFindPathAndRelatedTests extends AccumuloFindPathAndRelatedTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticFindPathAndRelatedTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloFindPathAndRelatedTests.accumuloResource = accumuloResource;
        super.before();
    }
