...
public class AccumuloElasticGraphFactory implements TestGraphFactory  {
    ElasticsearchResource elasticsearchResource;
    AccumuloResource accumuloResource;
    ...
    public AccumuloElasticGraphFactory withElasticsearchResource(ElasticsearchResource elasticsearchResource) {
        this.elasticsearchResource = elasticsearchResource;
        return this;
    }

    public AccumuloElasticGraphFactory withAccumuloResource(AccumuloResource accumuloResource) {
        this.accumuloResource = accumuloResource;
        return this;
    }
}
