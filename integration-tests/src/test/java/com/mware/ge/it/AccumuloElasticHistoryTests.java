...
import com.mware.ge.accumulo.AccumuloGeoTests;
import com.mware.ge.accumulo.AccumuloHistoryTests;
...
public class AccumuloElasticHistoryTests extends AccumuloHistoryTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticHistoryTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloHistoryTests.accumuloResource = accumuloResource;
        super.before();
    }
