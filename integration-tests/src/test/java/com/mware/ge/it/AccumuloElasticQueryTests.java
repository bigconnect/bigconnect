...
import com.mware.ge.accumulo.AccumuloMetadataTests;
import com.mware.ge.accumulo.AccumuloQueryTests;
...
public class AccumuloElasticQueryTests extends AccumuloQueryTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticQueryTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloQueryTests.accumuloResource = accumuloResource;
        super.before();
    }
