...
import com.mware.ge.accumulo.AccumuloSortingScoringTests;
...
public class AccumuloElasticSortingScoringTests extends AccumuloSortingScoringTests implements GraphTestSetup {
    @ClassRule
    public static final AccumuloResource accumuloResource = TestUtils.createAccumuloResource();

    @ClassRule
    public static final ElasticsearchResource elasticsearchResource = new ElasticsearchResource(AccumuloElasticSortingScoringTests.class.getName());

    @Before
    @Override
    public void before() throws Exception {
        elasticsearchResource.dropIndices();
        AccumuloSortingScoringTests.accumuloResource = accumuloResource;
        super.before();
    }
