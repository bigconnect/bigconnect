...
import static com.mware.ge.elasticsearch5.bulk.BulkUtils.calculateSizeOfId;

public class DeleteItem extends Item {
    private final int size;

    public DeleteItem(String indexName, String type, String docId, GeObjectId geObjectId) {
