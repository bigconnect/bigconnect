...
public class SearchResponseUtils {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(SearchResponseUtils.class);
    ...
    public static SearchResponse checkForFailures(SearchResponse searchResponse) {
        ...
        if (shardFailures.length > 0) {
            ...
            throw new GeException("search response shard failures", shardFailures[0].getCause());
        }
