...
public class ElasticGraphFactory implements TestGraphFactory {
    ...
    public Graph createGraph() throws Exception {
        ...
        Graph graph = InMemoryGraph.create(configuration);
        elasticsearchResource.dropIndices();
        return graph;
    }

    public ElasticGraphFactory withElasticsearchResource(ElasticsearchResource elasticsearchResource) {
