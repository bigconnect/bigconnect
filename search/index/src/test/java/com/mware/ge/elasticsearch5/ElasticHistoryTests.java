...
public class ElasticHistoryTests extends GraphHistoryTests implements GraphTestSetup {
    @ClassRule
    public static ElasticsearchResource elasticsearchResource = new ElasticsearchResource(ElasticHistoryTests.class.getName());
