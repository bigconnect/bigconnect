...
import com.mware.ge.base.GraphHistoryTests;
...
public class ElasticMetadataTests extends GraphMetadataTests implements GraphTestSetup {
    @ClassRule
    public static ElasticsearchResource elasticsearchResource = new ElasticsearchResource(ElasticMetadataTests.class.getName());
