...
public class ElasticSecurityTests extends GraphSecurityTests implements GraphTestSetup {
    @ClassRule
    public static ElasticsearchResource elasticsearchResource = new ElasticsearchResource(ElasticSecurityTests.class.getName());
