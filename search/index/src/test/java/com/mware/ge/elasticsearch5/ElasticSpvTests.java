...
public class ElasticSpvTests extends GraphSpvTests implements GraphTestSetup {
    @ClassRule
    public static ElasticsearchResource elasticsearchResource = new ElasticsearchResource(ElasticSpvTests.class.getName());
