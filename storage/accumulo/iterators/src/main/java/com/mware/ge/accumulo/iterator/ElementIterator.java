...
import com.mware.ge.accumulo.iterator.model.*;
...
public abstract class ElementIterator<T extends ElementData> implements SortedKeyValueIterator<Key, Value>, OptionDescriber {
    ...
    public ElementIterator(SortedKeyValueIterator<Key, Value> source, IteratorFetchHints fetchHints, boolean compressTransfer) {
    ...
    public static void setFetchHints(IteratorSetting iteratorSettings, IteratorFetchHints fetchHints) {
        ...
        addOption(iteratorSettings, SETTING_FETCH_HINTS_PREFIX + "includeEdgeIds", Boolean.toString(fetchHints.isIncludeEdgeIds()));
        addOption(iteratorSettings, SETTING_FETCH_HINTS_PREFIX + "includeEdgeVertexIds", Boolean.toString(fetchHints.isIncludeEdgeVertexIds()));
