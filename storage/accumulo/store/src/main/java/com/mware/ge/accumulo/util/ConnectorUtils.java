...
public class ConnectorUtils {
    public static ClientContext getContext(Connector connector) {
        if (!(connector instanceof ConnectorImpl)) {
            throw new GeException("Invalid connector type. Expected " + ConnectorImpl.class.getName() + " found " + connector.getClass().getName());
        }
        try {
            ...
            throw new GeException("Could not get context field", e);
        }
    }
}
