...
public class AccumuloBenchmarkTests extends GraphBenchmarkTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloBenchmarkTests.class);
