...
public class AccumuloFindPathAndRelatedTests extends GraphFindPathAndRelatedTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloFindPathAndRelatedTests.class);
