...
import com.mware.ge.base.GraphGeoTests;
...
public class AccumuloGeoTests extends GraphGeoTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloGeoTests.class);
