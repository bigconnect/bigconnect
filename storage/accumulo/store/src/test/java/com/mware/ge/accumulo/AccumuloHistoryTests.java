...
public class AccumuloHistoryTests extends GraphHistoryTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloHistoryTests.class);
