...
public class AccumuloQueryTests extends GraphQueryTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloQueryTests.class);
