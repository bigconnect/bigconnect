...
public class AccumuloSecurityTests extends GraphSecurityTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloSecurityTests.class);
