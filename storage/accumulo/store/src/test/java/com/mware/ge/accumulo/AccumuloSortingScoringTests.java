...
public class AccumuloSortingScoringTests extends GraphSortingScoringTests implements GraphTestSetup {
    private static final GeLogger LOGGER = GeLoggerFactory.getLogger(AccumuloSortingScoringTests.class);
