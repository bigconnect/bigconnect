...
public class RocksDBStdSessions extends RocksDBSessions {
    ...
    public RocksDBStdSessions(BigConfig config, String database, String store,
    ...
    private RocksDBStdSessions(BigConfig config, String database, String store,
    ...
    @Override
    public RocksDBSessions copy(BigConfig config,
    ...
    private static OpenedRocksDB openRocksDB(BigConfig config,
                                             String dataPath, String walPath)
                                             throws RocksDBException {
        // Init options
    ...
    public static void initOptions(BigConfig conf,
    ...
    private final class StdSession extends Session {
        ...
        public StdSession(BigConfig conf) {
