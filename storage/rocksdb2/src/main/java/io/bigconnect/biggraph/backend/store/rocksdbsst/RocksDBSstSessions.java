...
import io.bigconnect.biggraph.backend.store.rocksdb.RocksDBIngester;
import io.bigconnect.biggraph.backend.store.rocksdb.RocksDBSessions;
import io.bigconnect.biggraph.backend.store.rocksdb.RocksDBStdSessions;
...
public class RocksDBSstSessions extends RocksDBSessions {
    ...
    public RocksDBSstSessions(BigConfig config, String database, String store,
                              String dataPath) {
    ...
    public RocksDBSstSessions(BigConfig config, String dataPath,
    ...
    private RocksDBSstSessions(BigConfig config, String database, String store,
