...
public class TestCountingDWStub3 extends DataWorker {
    private static BcLogger LOGGER = BcLoggerFactory.getLogger(TestCountingDWStub3.class);
    ...
    public void execute(InputStream in, DataWorkerData data) throws Exception {
        ...
        Element element = data.getElement().prepareMutation()
                .setProperty("p3", Values.stringValue("v1 - " + Thread.currentThread().getName()), Visibility.EMPTY)
    ...
    public boolean isHandled(Element element, Property property) {
        if (property != null && "p2".equals(property.getName())) {
            return element.getPropertyValue("p3") == null;
        }
        return false;
    }
}
