...
import io.bigconnect.biggraph.backend.cache.LevelCache;
import io.bigconnect.biggraph.backend.cache.OffheapCache;
import io.bigconnect.biggraph.backend.cache.RamCache;
...
public abstract class CacheTest extends BaseUnitTest {
    ...
    public static class OffheapCacheTest extends CacheTest {
        ...
        private final BigGraph graph = Mockito.mock(BigGraph.class);
